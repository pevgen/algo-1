...
import static ml.pevgen.algo.algo1.structs.resizearray.ResizeableStackImpl.INITIAL_SIZE;
import static org.junit.jupiter.api.Assertions.*;

class ResizeableStackImplTest {

    private ResizeableStackImpl<String> resizeableStack;

    @BeforeEach
    public void setUp() {
        resizeableStack = new ResizeableStackImpl<>();
    }
